      ...
      >
        <tr>
          ...
          >
            <mdb-input
              type="checkbox"
              @keydown.native.enter="toggleSelectAll"
              @click.native="toggleSelectAll"
              :value="selected === 'all' ? true : false"
              filled
            ></mdb-input>
          </th>
      ...
      <mdb-tbl-body>
        ...
        >
          <td v-if="selectable || multiselectable" class="text-center" style="padding-top: 1rem; padding-bottom: 0;">
            <mdb-input
              type="checkbox"
              @keydown.native.enter="selectRow(row)"
              :value="(rowsDisplay.indexOf(row) === selected || selected === 'all' || Array.isArray(selected) && selected.includes(rowsDisplay.indexOf(row))) ? true : false"
              filled
            ></mdb-input>
          </td>
...
.mdb-datatable {
  ...
  .form-check-input[type=checkbox].filled-in:focus + label:after {
  ...
  .mdb-datatable-footer {
    ...
    .mdb-datatable-select, .mdb-datatable-select .md-form {
      margin-top: -0.25rem;
      margin-bottom: 0;
      width: 2.7rem;
      input {
    ...
    .dataTables_length .md-form input {
