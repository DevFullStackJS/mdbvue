<template>
  <div :class="componentWrapper">
      ...
      <div class="d-flex justify-content-center" style="position: relative;">
        <div class="mx-4" v-for="(step, index) in steps" :key="index">
          <mdb-btn
            ...
            :color="
              activeStep - 1 === index
                ? stepperOptions.withinBtn.active
                : stepperOptions.withinBtn.color
            "
            floating
              ...
              <span
                ...
                :class="
                  i + 1 < activeStep
                    ? 'success-color'
                    : i + 1 === activeStep
                    ? stepperOptions.stepBtn.active
                    : stepperOptions.stepBtn.color
                "
              >
    ...
    <div v-else :class="optionalColumnWrapper">
      <div :class="rowClass" :style="rowStyle">
        <div v-for="(step, index) in steps" :key="index">
          ...
          >
            ...
            <mdb-btn
              ...
              "
              :outline="
                stepperOptions.stepBtn.color || index + 1 === activeStep
                  ? null
                  : stepperOptions.stepBtn.outline
              "
              :iconClass="
                index + 1 === activeStep ? '' : stepperOptions.stepBtn.iconClass
              "
              slot="reference"
        ...
        <span
          :class="
            vertical
              ? `vertical-line ${stepperOptions.lineColor}`
              : `horizontal-line ${stepperOptions.lineColor}`
          "
        ></span>
      </div>
    </div>
    ...
    <div
      ref="contentRef"
      v-if="!(simpleH || simpleV)"
      :class="optionalContentWrapper"
    >
      ...
      <mdb-btn
        ...
        type="button"
        :color="
          stepperOptions.nextBtn.outline ? null : stepperOptions.nextBtn.color
        "
      ...
      <mdb-btn
        ...
        type="button"
        :color="
          stepperOptions.prevBtn.outline ? null : stepperOptions.prevBtn.color
        "
      ...
      <mdb-btn
        ...
        type="button"
        :color="
          stepperOptions.submitBtn.outline
            ? null
            : stepperOptions.submitBtn.color
        "
...
const Stepper = {
  ...
  methods: {
    ...
    changeActiveStep(i, unordered = false) {
      if ((this.linear && i > this.activeStep + 1) || this.disabled) return;
