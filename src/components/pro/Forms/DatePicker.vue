...
.mdb-datepicker input[type="text"]:not(.browser-default) ~ label{
  pointer-events: none;
}
.mdb-datepicker input[type="text"]:not(.browser-default):focus {
  border-color: #4285F4;
}
.mdb-datepicker input[type="text"]:not(.browser-default):focus ~ label{
  color: #4285F4;
}
</style>